            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center">
                        <img src="{{ asset('img/escudoet35.png') }}" alt="Escudo ET35" class="h-8 w-auto mr-2">
                        <span class="font-bold text-xl text-gray-800 dark:text-white">ET35</span>
                    </a>
                </div>
                        ...
                        <x-slot name="trigger">
                            <button class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 dark:text-gray-300 dark:hover:text-white focus:outline-none transition duration-150 ease-in-out">
                                ...
                                <div class="relative">
                                    ...
                                    @endif
                                    <span class="absolute bottom-0 right-0 block h-2 w-2 rounded-full bg-green-400 ring-2 ring-white dark:ring-gray-800"></span>
                                </div>
                            </button>
                        </x-slot>
                        ...
                        <x-slot name="content">
                            ...
                            <form method="POST" action="{{ route('logout') }}" x-data>
                                ...
                                <x-dropdown-link href="{{ route('logout') }}"
                                         @click.prevent="$root.submit();" class="flex items-center text-red-600 dark:text-red-400">
                                    <svg class="mr-2 h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
