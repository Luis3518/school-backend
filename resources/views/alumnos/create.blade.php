...
<body>
    <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
        <h1 class="text-2xl font-medium text-gray-900">Crear Alumno</h1>
    </div>
    ...
    <div class="bg-gray-200 bg-opacity-25 p-6 lg:p-8">
        <form action="{{ route('alumnos.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" id="dni" name="dni" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            </div>
            <div>
