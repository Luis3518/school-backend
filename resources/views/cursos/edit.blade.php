                ...
                <div class="p-6 sm:p-8">
                    ...
                    <form action="{{ route('cursos.update', $curso->id) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nombre" id="nombre" value="{{ $curso->nombre }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white" required>
                        </div>
